...
public abstract class ATWiseCommand extends ASAT4JAnalysisCommand<BooleanAssignmentList> {
     ...
     */
    public static final AOption<Path> INITIAL_FIXED_SAMPLE_OPTION = Options.newOption(
     ...
     */
    public static final AOption<Path> INITIAL_VARIABLE_SAMPLE_OPTION = Options.newOption(
