...
public class ProjectionCommand extends ACommand {
     ...
     */
    public static final MultiOption<String> LITERALS_SLICE_OPTION = (MultiOption<String>)
            Options.newListOption("slice", Options.StringParser).setDescription("Literals to be removed.");

    /**
     * Literals to be kept
     */
    public static final MultiOption<String> LITERALS_PROJECT_OPTION = (MultiOption<String>)
    ...
    public int run(OptionList optionParser) {
        ...
        IComputation<BooleanAssignmentList> computation =
                Computations.of(cnf).map(CNFSlicer::new).set(CNFSlicer.VARIABLES_TO_REMOVE, new Variables(array));
