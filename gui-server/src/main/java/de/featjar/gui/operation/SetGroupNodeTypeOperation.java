 ...
 * This triggers the {@link SetGroupNodeTypeHandler}.
 *
 ...
 */
public class SetGroupNodeTypeOperation extends Operation {

    public static final String KIND = "setGroupNodeType";
    private String elementId;
    private String nodeType;

    public SetGroupNodeTypeOperation() {
        super(KIND);
    }
    ...
    public Result<GroupNodeType> getNodeType() {
        return GroupNodeType.fromValue(nodeType);
    }
}
