...
public abstract class AAnalysisCommand<T> extends ACommand {
    ...
    public static final Option<Boolean> NON_PARALLEL = Options.newFlag("non-parallel")
            .setDescription(
     ...
     */
    public static final Option<Path> TIME_OPTION = Options.newOption("write-time-to-file", Options.PathParser)
