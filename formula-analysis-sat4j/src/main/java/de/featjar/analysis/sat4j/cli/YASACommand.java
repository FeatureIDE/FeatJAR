...
public class YASACommand extends ATWiseCommand {
     ...
     */
    public static final AOption<Integer> ITERATIONS_OPTION = Options.newOption("i", Options.IntegerParser) //
    ...
    public static final AOption<Boolean> INCREMENTAL = Options.newFlag("incremental") //
