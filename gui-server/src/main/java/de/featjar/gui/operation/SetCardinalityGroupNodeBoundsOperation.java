 ...
 * This triggers the {@link SetCardinalityGroupNodeBoundsHandler}.
 *
 ...
 */
public class SetCardinalityGroupNodeBoundsOperation extends Operation {
    public static final String KIND = "setCardinalityGroupNodeBounds";

    private String elementId;
    private int lowerBound;
    private int upperBound;

    public SetCardinalityGroupNodeBoundsOperation() {
        super(KIND);
    }
