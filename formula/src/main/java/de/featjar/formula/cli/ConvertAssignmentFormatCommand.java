...
public class ConvertAssignmentFormatCommand extends ACommand {
    ...
    public static final AOption<IFormatSupplier<BooleanAssignmentGroups>> INPUT_FORMAT =
            Options.newInputFormatOption(BooleanAssignmentGroupsFormats.class);

    public static final AOption<IFormat<BooleanAssignmentGroups>> OUTPUT_FORMAT = Options.newOutputFormatOption(
