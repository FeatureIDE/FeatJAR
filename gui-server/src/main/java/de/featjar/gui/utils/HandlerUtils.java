...
/**
 * Contains static utility functions used in many handlers.
 */
...
public final class HandlerUtils {
    ...
    public static void logIdentifiableCreation(final Identifiable newIdentifiable) {
        // TODO maybe use another stream instead of error
        FeatJAR.log().debug(" Created " + newIdentifiable.getClass() + "with ID " + newIdentifiable.getId());
    }
}
